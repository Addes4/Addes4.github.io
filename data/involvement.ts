...
export const events: EventEntry[] = [
  ...
  },
  {
    ...
    organization: 'KTH AI Society',
    description: 'A workshop with 60+ participants. We partnered with Mannheimer Swartling to hear more about AI legislation and regulations.',
  },
  {
    date: 'January 2026',
  ...
  },
  {
    ...
    organization: 'KTH AI Society',
    description: 'Initiated a partnership with Jane Street to get our students access to the best resources and opportunities in the industry. We are now hosting a series of events with Jane Street.',
  },
  {
    date: 'February 2026',
    name: 'Hackeurope 2026',
    organization: 'KTH AI Society',
    description: 'A 24-hour hackathon with 300+ participants. We partnered with HackEurope, Susquehanna International Group and Founders House to host the hackathon.',
  },
]
